...
public class MembersAdapter extends RecyclerView.Adapter<MembersAdapter.ViewHolder>{
    ...
    ArrayList<ItemMembers> dataMembers;
    private Context context;

    public MembersAdapter(ArrayList<ItemMembers> dataMembers, Context context) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        final ItemMembers itemMembers = dataMembers.get(position);
        holder.txtNameUser.setText(itemMembers.getName());
        String url = itemMembers.getImgUser();
